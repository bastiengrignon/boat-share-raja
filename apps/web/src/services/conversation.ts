...
export const conversationService = {
  ...
  sendMessage: async ({ conversationId, senderId, content }: SendMessage) =>
    (await boatSharingApi.post(`${conversationRoute}/${conversationId}/messages`, { senderId, content })).data,
